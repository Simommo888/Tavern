...
class LiveRoomService:
    def __init__(self, workspace_root: str | Path = ".", llm: Any | None = None, repository: FileLiveRoomRepository | None = None) -> None:
        self.repository = repository or FileLiveRoomRepository(workspace_root)
