...
import { absoluteApiUrl, eventStreamUrl, getSession } from '@/lib/api/live';
import type { AnchorReply, LiveEvent, LiveRoomSession } from '@/types/live';
...
export default function ObsPlayer({ sessionId, autoplay = true }: { sessionId: string; autoplay?: boolean }) {
